...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">LUXURY ROOMS</h2>
    ...
    <!-- Rooms Area Start -->
    <!-- <form action="room.php?action=add_to_room= php echo $row["id"]; " method="post"> -->
        ...
        <div class="container">
            <div class="row">
                ...
                $select_room = mysqli_query($con, "SELECT * FROM `room` r 
                                   WHERE r.cate_nm = 'Luxury Rooms' 
                                   AND r.room_nm NOT IN (SELECT c.name FROM `cart` c)");

                // $select_room = mysqli_query($con, "SELECT * FROM `room` WHERE cate_nm='Luxury Rooms'");  
                ...
                ?>
                    ...
                    <div class="single-room-area d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="room-content">
                           ...
                           <!-- <a href="select.php" class="btn roberto-btn w-100">Book Now <i class="fa fa-long-arrow" aria-hidden="true"></i></a> -->
                        </div>
                    </div>
                    </form>
                    <?php
