            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-date">January 5, 2024</a>
                        ...
                        <p>How many free autoresponders have you tried? And how many emails did you get through using
                            them?</p>
                        <a href="index.php
                        " class="btn continue-btn"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-date">February 21, 2024</a>
                            <a href="#" class="post-catagory">Event</a>
                        </div>
                        <!-- Post Title -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="700ms">
                        ...
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-date">April 10, 2024</a>
                            <a href="#" class="post-catagory">Event</a>
                        </div>
                        <!-- Post Title -->
